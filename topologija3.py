...
def topology():
    ...
    net.addLink(s16, h51, 4, 0, bw=1024)
    net.addLink(h50, s9, 0, 4, bw=1024)
    net.addLink(s38, s16, 4, 3)
    net.addLink(s39, s16, 2, 2)
    net.addLink(s38, s13, 3, 3)
    net.addLink(s13, s16, 2, 1)
    net.addLink(s3, s13, 3, 1)
    net.addLink(s38, s14, 2, 2)
    net.addLink(s14, s39, 1, 1)
    net.addLink(s12, s38, 3, 1)
    net.addLink(s11, s12, 2, 2)
    net.addLink(s10, s11, 4, 1)
    net.addLink(s10, s12, 3, 1)
    net.addLink(s6, s10, 3, 2)
    net.addLink(s8, s7, 3, 4)
    net.addLink(s9, s7, 3, 3)
    net.addLink(s6, s7, 2, 2)
    net.addLink(s8, s6, 2, 1)
    net.addLink(s9, s8, 2, 1)
    net.addLink(s5, s9, 3, 1)
    net.addLink(s10, s4, 1, 6)
    net.addLink(s7, s4, 1, 5)
    net.addLink(s2, s3, 3, 2)
    net.addLink(s4, s3, 4, 1)
    net.addLink(s4, s2, 3, 2)
    net.addLink(s4, s1, 2, 3)
    net.addLink(s5, s4, 2, 1)
    net.addLink(s1, s5, 2, 1)
